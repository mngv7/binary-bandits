package com.example.protrack.deprecated;
...
public class ProTrackController {
...
//    }
    ...
    private void handleAddWorkstation() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("CreateWorkstation.fxml"));
    ...
    private void handleAllocateWorkstation() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("AllocateWorkstation.fxml"));
        Parent root = loader.load();
