...
class WorkOrderProductTest {
    ...
    void testSetQuantity() {
        WorkOrderProduct product = new WorkOrderProduct(1, "Widget", 10, 5.99, 59.90);
    ...
    @Test
    void testZeroValues() {
        WorkOrderProduct product = new WorkOrderProduct(2, "Gadget", 0, 0.0, 0.0);
    ...
    void testLargeValues() {
        ...
        try {
            WorkOrderProduct product = new WorkOrderProduct(3, "Product", Integer.MAX_VALUE, Double.MAX_VALUE, Double.MAX_VALUE);
